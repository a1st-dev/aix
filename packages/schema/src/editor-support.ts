...
export const editorSupportProfiles = [
   ...
   },
   {
      id: 'gemini',
      name: 'Gemini',
      summary: 'Native GEMINI.md rules, TOML command prompts, MCP, skills, and hooks.',
      migrationPitch: 'Gemini is a strong target for native prompts, MCP, and the new hooks system.',
      notes: [
   ...
   },
   {
      ...
      notes: [
         ...
         'OpenCode supports plural directory names (e.g., `agents/`, `skills/`) in newer versions.',
      ],
      terminology: [
         { featureId: 'rules', aixTerm: 'Rules', editorTerm: 'AGENTS.md' },
         { featureId: 'prompts', aixTerm: 'Prompts', editorTerm: 'Commands' },
   ...
   },
   {
      id: 'devin-desktop',
      name: 'Devin Desktop',
      summary: 'Devin Desktop (formerly Windsurf) with native rules, workflows, skills, and hooks.',
      migrationPitch: 'Devin Desktop is the evolution of Windsurf, optimized for agentic workflows.',
      notes: [
         'Devin Desktop is the rebrand of Windsurf.',
         'It supports plural directory names and the `.devinignore` file.',
      ],
      terminology: [
         { featureId: 'prompts', aixTerm: 'Prompts', editorTerm: 'Workflows' },
         { featureId: 'rules', aixTerm: 'Rules', editorTerm: 'Rules' },
      ...
      features: {
         rules: feature(
            ...
            'native',
            'Rules',
            'Markdown rule files with trigger frontmatter.',
            nativeScope('.windsurf/rules/*.md'),
            nativeScope('~/.codeium/windsurf/memories/global_rules.md'),
            {
               supportedValues: [ 'always_on', 'model_decision', 'glob', 'manual' ],
         ...
         agents: feature(
            ...
            'unsupported',
            'Agents',
            'Devin Desktop does not document custom agent files that aix can write safely.',
            unsupportedScope('aix reports configured agents as unsupported for Devin Desktop.'),
            unsupportedScope('aix reports configured agents as unsupported for Devin Desktop.'),
         ),
         mcp: feature(
            'mcp',
            ...
            'MCP servers',
            'Global-only JSON MCP configuration.',
            unsupportedScope('Devin Desktop does not have a project-scoped MCP config file in aix.'),
            nativeScope('~/.codeium/windsurf/mcp_config.json'),
         ),
         skills: feature(
            'skills',
            ...
            nativeScope('~/.windsurf/skills/{name}/'),
            {
               notes: [ 'Devin Desktop also discovers `.agents/skills/` for compatibility.' ],
            },
         ),
         hooks: feature(
            'hooks',
            'native',
            'Hooks',
            'JSON hook configuration using snake_case events.',
            nativeScope('.windsurf/hooks.json'),
            nativeScope('~/.windsurf/hooks.json'),
            {
               supportedValues: [
         ...
         'agents-md': feature(
            ...
            'native',
            'AGENTS.md',
            'Compatibility with AGENTS.md repository files.',
            nativeScope('AGENTS.md'),
            unsupportedScope('Windsurf documentation focuses on workspace files.'),
         ),
         'agents-dir': feature(
            'agents-dir',
            'native',
