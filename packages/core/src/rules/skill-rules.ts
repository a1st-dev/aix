 ...
 * `.agents/skills/{name}/` preserving their full directory structure (SKILL.md, scripts/,
...
export async function loadSkillRules(skill: ParsedSkill, _editor?: string): Promise<LoadedRule[]> {
   ...
   // The actual skill content lives in .agents/skills/{name}/ and preserves the full structure
